...
import (
	...
	"github.com/docker/libnetwork/drivers/external"
...
type NetworkController interface {
	...
	RegisterExternalDriver(name string, plugin external.Plugin)
}
...
func (c *controller) RegisterExternalDriver(name string, plugin external.Plugin) {
	c.drivers[name] = external.New(plugin)
}
